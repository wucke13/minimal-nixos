...

{
  imports = [
    ...
    (flakeRoot + "/nixos-modules/embedded/gdb-launcher.nix")
    (flakeRoot + "/nixos-modules/embedded/nixos-debloat.nix")
    (flakeRoot + "/nixos-modules/embedded/standalone-ramdisk.nix")
  ];
